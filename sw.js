const C='sao-workplace-v6-2-final-stable';
const A=['./','./index.html','./styles.css?v=6.2.0','./app.js?v=6.2.0','./cloud-sync.js?v=6.2.0','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png','./vision-50-years.png'];
