const C='sao-workplace-v6-5-packing-readiness';
const A=['./','./index.html','./styles.css?v=6.5.0','./app.js?v=6.5.0','./cloud-sync.js?v=6.5.0','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png','./vision-50-years.png'];
